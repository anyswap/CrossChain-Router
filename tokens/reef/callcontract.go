...
func (b *Bridge) GetErc20TotalSupply(contract string) (*big.Int, error) {
	...
	result, err := b.CallContract(contract, data, 0, "latest")
	if err != nil {
		return nil, err
	}
...
func (b *Bridge) GetErc20Balance(contract, address string) (*big.Int, error) {
	...
	result, err := b.CallContract(contract, data, 0, params.GetBalanceBlockNumberOpt)
	if err != nil {
		return nil, err
	}
	return common.GetBigIntFromStr(result)
...
func (b *Bridge) GetFactoryAddress(contractAddr string) (string, error) {
	...
	res, err := b.CallContract(contractAddr, data, 0, "latest")
	if err != nil {
		return "", err
	}
